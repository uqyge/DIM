...
%=============================== input ====================================
%==========================================================================
data=csvread('gauss1_samples.csv',1,0);
for nn=1:size(data,1)
    act_pct=[data(nn,1);data(nn,2);data(nn,3);data(nn,4)];
%     驱动调整
    
    
    T_up=data(nn,5);           %上绳温度
    T_mid=data(nn,6);          %中绳温度
    T_down=data(nn,7);           %下绳温度
...
writetable(result_table,'displace_23.csv');
