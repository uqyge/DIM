function [nod_now]=Disposal(nnode,nod,m,n,nelem_spring,nelem_bar,nelem_cable,cluster,ele_spring,ele_bar,ele_cable,ele_cluster,dis1)
  ...
  %============================= plot springs ==================================
        ...
        for ie=1:nelem_bar
            ...
            if(fal==2)
                ...
                plot([xxi,xxj],[zzi,zzj],'-o','color','b','linewidth',3,...
                    'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',3)
            else
                plot3([xxi,xxj],[yyi,yyj],[zzi,zzj],'-o','color','b','linewidth',3,...
                    'MarkerEdgeColor','k','MarkerFaceColor','b','MarkerSize',3)
        ...
        xlabel('x axis (cm)','Fontsize',11)
        ylabel('y axis (cm)','Fontsize',11)
        zlabel('z axis (cm)','Fontsize',11)
        

        for kk=1:nnode
            
            if(kk==18||kk==23)
            text( nod_now(kk,1)+0.01,nod_now(kk,2)+0.01,nod_now(kk,3)+0.01 ,num2str(kk), 'fontsize',12, 'color', 'k' )
            end
        end
